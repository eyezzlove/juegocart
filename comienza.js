...
document.querySelectorAll(".reiniciar").forEach(function(elemento){elemento.addEventListener("click", reiniciar)})

document.querySelector("#competitivo").addEventListener("click", iniciaJuegoNormal)
document.querySelector("#relax").addEventListener("click", iniciaJuegoRelax)
